...
// (NO-BUNDLED-SKILLS) Upstream renders a Skills section here from
// `plugin.pluginSkills`, backed by the deleted SkillIcon component. The fork
// ships no bundled skills and never lists them, so the detail page is
// connections plus manifest information.
