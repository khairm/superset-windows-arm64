...
export function PluginsView() {
	...
	// (NO-BUNDLED-SKILLS) Upstream wraps this page in Plugins/Skills tabs; the
	// fork ships no bundled skills, so the page is the plugins list itself and
	// the tab strip would be a single tab over nothing.
	return (
