...
export function NewWorkspaceScreen({
	...
	// this person shipped anything yet. Upstream reads that off the row count
	// because nothing seeds a workspace there; this fork still mints a master
	// per project, so a master cannot count.
				...
				>
					...
					<div className="mt-2 flex items-center justify-between gap-2">
						<div className="flex min-w-0 flex-1 items-center gap-2">
							...
							draft.isSession || isMasterMode ? null : draft.hostId ===
								CLOUD_HOST_ID ? (
