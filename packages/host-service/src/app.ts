...
export function createApp(options: CreateAppOptions): CreateAppResult {
	...
	void (async () => {
		...
		// time after upgrade. (MASTER-ALWAYS-ACTIVE): upstream retired this
		// sweep with the main-workspace concept in desktop-v1.30.1; the fork
		// keeps it, because a lost master has to be rebuildable.
