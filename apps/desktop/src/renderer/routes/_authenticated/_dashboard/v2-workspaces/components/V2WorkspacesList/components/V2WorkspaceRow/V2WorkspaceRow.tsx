			...
			{(actions) => (
				...
				>
					...
					{deleting ? (
						...
						// (KANBAN COMPLETED) the thread is completed on the kanban board
						// and deliberately has NO sidebar surface, so this glyph is the
						// only place the list says so. Restoring is board-only (drag its
						// card out of Completed).
						<Tooltip delayDuration={300}>
							<TooltipTrigger asChild>
								<span title="">
									<LuCircleCheck
