...
/**
 * (NO-BUNDLED-SKILLS) Upstream declares this shape in `managed-skills`, the
 * retired Superset-managed-skills provisioner this fork removed. It is plain
 * plugin metadata — an installed plugin's ledger name and its directory — so
 * it is declared here rather than dragging the retired module back; nothing
 * about the ledger this file reads changes.
 */
