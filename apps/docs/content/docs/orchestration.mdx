...
Ask the agent you're already talking to for parallel work and tell it to use the Superset CLI. It can create an isolated workspace per worker, launch an agent in each, send follow-ups over their terminals, and collect the results. `superset --help` lists the available commands.
